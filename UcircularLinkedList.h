...
// UI for the circular linked list
class UcircularLinkedList : public wxPanel {
...
public:
	...
	wxStaticBitmap* arrow3[15];
	wxStaticBitmap* arrow4[15];
	bool skip_sbs = false;

	UcircularLinkedList(wxPanel* parent);
